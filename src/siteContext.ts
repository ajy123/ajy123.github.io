...
const PROFILE: SiteProfile = {
  ...
  facts: [
    ...
    "Her weekly pipeline turns interviews, support tickets, product usage and past queries into updated personas, which cut research synthesis from over six hours a week to about one. The same pipeline also ranks that material, plus PRDs, into feature themes, scores them with RICE, and drafts directions for the top ones. One workflow, not two.",
    "That ranking produced fourteen features on its first run and now adds three to five a week while re-ranking the rest.",
    "Design directions exist before the PRD is written, so design stops waiting on the document and about a week of waiting comes out of every feature.",
