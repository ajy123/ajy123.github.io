...
const PROFILE: SiteProfile = {
  ...
  facts: [
    ...
    "That same weekly pipeline also ranks what it reads: agents cluster tickets, PRDs, and transcripts into feature themes, score the themes with RICE, and draft design directions for the top ones. It is one workflow, not two, and it is the prioritization flow the Deeli case study refers to.",
    "It produced fourteen features on its first run, enough to sketch what the product could become, and now adds three to five a week while re-ranking the ones already in the list.",
    "Because those directions exist before the PRD is written, design stops waiting on the document and about a week of waiting comes out of every feature. Joanna still owns which direction the company can stand behind; the workflow produces exploration, not finished design.",
