...
const PROFILE: SiteProfile = {
  ...
  facts: [
    ...
    "Designer and engineer in practice: she works across Figma and code (React, Vue), ships what she designs, and did junior front-end work while she was at Swiftly.",
