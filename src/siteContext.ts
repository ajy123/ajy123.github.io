...
const PROFILE: SiteProfile = {
  ...
  facts: [
    ...
    "Her personas and research regenerate every week because new interviews, tickets and usage land every week, and that is when the team learns something new about users.",
    ...
    "Her weekly synthesis pipeline turns interviews, support tickets, product usage and past queries into updated personas, which cut research synthesis from over six hours a week to about one. The same pipeline also ranks that material, plus PRDs, into feature themes, scores them with RICE, and drafts directions for the top ones. One workflow, not two.",
    "That synthesis pipeline's ranking produced fourteen features on its first run and now adds three to five a week while re-ranking the rest.",
    "Its directions are exploration, not finished design, and they exist before the PRD is written, so design stops waiting and about a week of waiting comes out of every feature.",
    ...
    "To put more evidence behind what real users already told her, she runs her personas through AI-generated scenarios, which widens coverage beyond the users she can reach directly.",
