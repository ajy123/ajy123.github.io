...
const PROFILE: SiteProfile = {
  ...
  facts: [
    ...
    "Her synthesis pipeline turns interviews, support tickets, product usage and past queries into updated personas, which cut research synthesis from over six hours a week to about one.",
    "That same weekly pipeline also ranks what it reads: agents cluster that material, plus PRDs, into feature themes, score them with RICE, and draft directions for the top ones. One workflow, not two.",
