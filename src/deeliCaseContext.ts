...
export const DEELI_CASE_CONTEXT: string = [
  ...
  `- Deeli: an enterprise deep-tech research product. Client: a top-5 semiconductor foundry. Joanna: the only designer, research to launch, on a 5-engineer build. Launched June 2026; impact measured over the first 2 weeks live.`,
